...
public class decline_subsidy_view extends AppCompatActivity {
    ListView DECLINE_DATA;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.decline_subsidy_view);
        DECLINE_DATA=(ListView)findViewById(R.id.subsidy_data);
        DECLINE_SUBSIDY_VIEW();
    }
    ...
    public  class cust_Adapter extends BaseAdapter {
        ...
        public cust_Adapter(decline_subsidy_view context, ArrayList<subsidy_GT> ar) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView = inflater.inflate(R.layout.decline_subsidy_list, null);
    ...
    public void DECLINE_SUBSIDY_VIEW() {
        ...
        call.enqueue(new Callback<SubsidyData>() {
            ...
            public void onResponse(Call<SubsidyData> call, Response<SubsidyData> response) {
                ...
                {
                    Toast.makeText(decline_subsidy_view.this, "Success", Toast.LENGTH_SHORT).show();
                    cust_Adapter ca = new cust_Adapter(decline_subsidy_view.this, subsidyData.getData());
                    DECLINE_DATA.setAdapter(ca);
                }
                else
                {
                    Toast.makeText(decline_subsidy_view.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<SubsidyData> call, Throwable t) {
                ...
                Toast.makeText(decline_subsidy_view.this, "Fail to fetch data", Toast.LENGTH_SHORT).show();
