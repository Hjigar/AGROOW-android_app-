...
public class admin_m_reports  extends AppCompatActivity {
    ListView Report_data;
    String uid;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.admin_m_reports);
    ...
    private void REPORT_VIEW(String uid) {
        ...
        call.enqueue(new Callback<ReportData>() {
            ...
            public void onResponse(Call<ReportData> call, Response<ReportData> response) {
                ...
                Toast.makeText(admin_m_reports.this, "Report Data", Toast.LENGTH_SHORT).show();
                cust_Adapter ca=new cust_Adapter(admin_m_reports.this,reportData.getData());
                Report_data.setAdapter(ca);
            }

            @Override
            public void onFailure(Call<ReportData> call, Throwable t) {
                Toast.makeText(admin_m_reports.this, "fail to fetch", Toast.LENGTH_SHORT).show();
    ...
    public class cust_Adapter extends BaseAdapter {
        ...
        public cust_Adapter(admin_m_reports context, ArrayList<report_GT> ar) {
