...
public class decline_license_view extends AppCompatActivity {
    ListView DECLINE_DATA;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.decline_license_view);
        DECLINE_DATA=(ListView)findViewById(R.id.license_data);
        manage_license_m();
    }
    ...
    public  class cust_Adapter extends BaseAdapter {
        ...
        public cust_Adapter(decline_license_view context, ArrayList<license_GT> ar) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView = inflater.inflate(R.layout.decline_license_list, null);
    ...
    public void manage_license_m() {
        ...
        call.enqueue(new Callback<LicenseData>() {
            ...
            public void onResponse(Call<LicenseData> call, Response<LicenseData> response) {
                ...
                {
                    Toast.makeText(decline_license_view.this, "Success", Toast.LENGTH_SHORT).show();
                    cust_Adapter ca = new cust_Adapter(decline_license_view.this, licenseData.getData());
                    DECLINE_DATA.setAdapter(ca);
                }
                else
                {
                    Toast.makeText(decline_license_view.this, "Error", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<LicenseData> call, Throwable t) {
                ...
                Toast.makeText(decline_license_view.this, "Fail to fetch data", Toast.LENGTH_SHORT).show();
